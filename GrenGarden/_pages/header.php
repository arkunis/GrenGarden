            ...
            <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <button type="button" class="flex text-sm bg-white rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                    ...
                    <div class="relative">
                        ...
                        <span class="top-0 left-7 absolute w-6 h-6 bg-green-400 border-2 border-white dark:border-gray-800 rounded-full">8</span>
                    </div>
                </button>
                <!-- Dropdown menu -->
                ...
                <?php if(isset($_SESSION['login']) == true){ ?>
                    ...
                    <ul class="py-2" aria-labelledby="user-menu-button">
                        <li>
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Mon panier</a>
                        </li>
                        <?php if(isset($_SESSION['login']) == true){ ?>
                        <li>
